module TopsHelper
  def map_init
    if not map = GameMap.first
      ...
      next_intersections = [[1,5,17],[0,2,16],[1,3],[2,4],[3,5,7],[0,4,6],[5,9,19],[4,8],[7,9,11],[6,8,10],[9,13,21],[8,12],[11,13],[10,12],[15,17,28],[14,16,27],[1,15],[0,14,18],[17,19,30],[6,18,20],[19,21,32],[10,20,22],[21,24,34],[24],[22,23],[26,28,39],[25,27],[15,26],[14,25,29],[28,30,40],[18,29,31],[30,32,42],[20,31,33],[32,34,44],[22,33,35],[34,37,46],[37],[35,36],[39,40,48],[25,38],[29,38,41],[40,42,49],[31,41,43],[42,44,51],[33,43,45],[44,46,53],[35,45],[48,49],[38,47],[41,47,50],[49,51],[43,50,52],[51,53],[45,52]]
      19.times do |i|
      ...
      next_intersections.each_with_index do |nexts, center|
        intersections.find_by(position: center).vertices.each_with_index do |v, index|
          v.update next_intersection_id: nexts[index] ? intersections[nexts[index]].id : nil
        end
      end
    end
    map
