...
window.image_path = function(name){
  let fname = {"normal.png":"/assets/normal-abb24301158fe5e6c704ce778a39273b9770067d406f5d9b6eb1d03907d0fd5c.png","road.png":"/assets/road-888abe78fc554d5d42ddc97e849ee7c2e55d4ffe294577a052310c3771839ca5.png","special.png":"/assets/special-6c5864f0f6b7ef7c854eed9849d22aa1f5bd6f4442aa7cb63faea07f0b18c571.png","nothing.png":"/assets/nothing-d2561ffa1a2317b42eeece291ae1dbccd7820131ea55c7ebe83a095d4c6e9ee7.png","bridge.png":"/assets/bridge-3563e61ebd1851345e919db0f27a2faeca4943afd890000de47be008749cc982.png"}[name]
  for(let ext of ["jpg", "png"]){
    fname = fname || {"normal.png":"/assets/normal-abb24301158fe5e6c704ce778a39273b9770067d406f5d9b6eb1d03907d0fd5c.png","road.png":"/assets/road-888abe78fc554d5d42ddc97e849ee7c2e55d4ffe294577a052310c3771839ca5.png","special.png":"/assets/special-6c5864f0f6b7ef7c854eed9849d22aa1f5bd6f4442aa7cb63faea07f0b18c571.png","nothing.png":"/assets/nothing-d2561ffa1a2317b42eeece291ae1dbccd7820131ea55c7ebe83a095d4c6e9ee7.png","bridge.png":"/assets/bridge-3563e61ebd1851345e919db0f27a2faeca4943afd890000de47be008749cc982.png"}[name + "." + ext]
  }
  return fname;
}
;
...
(function() {
  $(function() {
    var ws;
    ws = websocket();
    ws.bind("notice", function(data) {
      return alert(data.result);
    });
    ws.bind("chat_receive", function(data) {
      return $("#msg_view").prepend("<li>" + data + "</li>");
    });
    ws.bind("draw_building", function(data) {
      var target;
      target = $($("." + data.place)[data.position]);
      return target.attr({
        "src": image_path(data.building_type)
      });
    });
    return ws.bind("draw_info", function(data) {
      return $(".info-wrap").html(data);
    });
  });
